...
- महत्वपूर्ण मीट्रिक **कमिट चार्ज** है, न कि "फ्री रैम"।


बिल्ड गवर्नर एक हल्का गवर्नर है जो **स्वचालित रूप से** आपके बिल्ड सिस्टम और कंपाइलर के बीच बैठता है:

1. **शून्य-कॉन्फ़िगरेशन सुरक्षा** — रैपर पहले बिल्ड पर स्वचालित रूप से गवर्नर को शुरू करते हैं।
2. **अनुकूल समानांतरता** जो जॉब की संख्या के बजाय कमिट चार्ज पर आधारित है।
...
5. **सुरक्षित** — यदि गवर्नर डाउन है, तो उपकरण बिना गवर्न किए चलते हैं।
...
| [`Gov.Common`](https://www.nuget.org/packages/Gov.Common) | [![NuGet](https://img.shields.io/nuget/v/Gov.Common)](https://www.nuget.org/packages/Gov.Common) | विंडोज मेमोरी मीट्रिक, OOM वर्गीकरण, ऑटो-स्टार्ट क्लाइंट। |
...
| भारी संकलन (बूस्ट/जीआरपीसी) | 2–4 | टेम्प्लेट-भारी |
| `/GL` के साथ संकलन | +3 | LTCG कोड जनरेशन |
| Link | 4 | बेस लिंक कॉस्ट |
| `/LTCG` के साथ लिंक करें | 8–12 | पूर्ण LTCG |

## थ्रॉटल स्तर

| कमिट अनुपात | Level | व्यवहार |
| -------------- | ------- | ---------- |
| < 80% | सामान्य | तुरंत टोकन प्रदान करें |
| 80–88% | सावधानी | धीमी प्रदान, 200 मिलीसेकंड की देरी |
| 88–92% | सॉफ्टस्टॉप | महत्वपूर्ण देरी, 500 मिलीसेकंड |
...
- **संभावित OOM**: उच्च कमिट अनुपात + प्रक्रिया ने उच्च स्तर पर चरम पर प्रदर्शन किया + कंपाइलर निदान अनुपस्थित
- **संभावित पेजिंग डेथ**: मध्यम दबाव संकेत
- **सामान्य संकलन त्रुटि**: stderr में कंपाइलर निदान मौजूद
- **अज्ञात**: निर्धारित नहीं किया जा सकता
...
- **सुरक्षित**: यदि गवर्नर अनुपलब्ध है, तो रैपर बिना गवर्न किए टूल चलाते हैं।
...
| `GOV_REAL_LINK` | वास्तविक link.exe फ़ाइल का पथ (स्वचालित रूप से पता लगाया गया)। |
| `GOV_ENABLED` | `gov run` द्वारा नियंत्रित मोड को दर्शाने के लिए सेट किया गया। |
| `GOV_SERVICE_PATH` | स्वचालित रूप से शुरू करने के लिए Gov.Service.exe फ़ाइल का पथ। |
| `GOV_DEBUG` | विस्तृत स्वचालित शुरुआत लॉगिंग के लिए इसे "1" पर सेट करें। |
...
## स्वचालित शुरुआत व्यवहार।

ये रैपर एक वैश्विक म्यूटेक्स का उपयोग करते हैं ताकि यह सुनिश्चित किया जा सके कि केवल एक ही गवर्नर इंस्टेंस चल रहा है।
